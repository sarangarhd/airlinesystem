...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Smart Wing Airways Online Ticketing</a>
    </div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
			 ...
			 <div class="panel panel-success">
			 	<div class="panel-heading">
			 		<h3 class="panel-title"><center>ITINERARY</center></h3>
			 	</div>
			 	<div class="panel-body">
			 		<strong>
			 			<i>Smart Wing Airways - Sri Lanka ~ A Symbol of fly</i>
			 			<h3>
			 			...
			 			<p>Departure Date: <?= $_SESSION['departure_date']; ?> @<?= $flght['d_time']; ?> </p>
			 		</strong>
			 			<i>Estimated Arrival Time: <?= $flght['on_day']; ?> @<?= $flght['a_time']; ?></i><br />
						<i>Flight Number - <?= $flght['Route_name']; ?></i><br />
						 ...
						 <br>
						 <i>Air Craft : <?= $flght['make']; ?> - <?= $flght['model']; ?></i><br />
